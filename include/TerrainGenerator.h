...
private:
	...
	PerlinNoise2d noise;
	std::vector<std::vector<Vect3d>> generatedPoints;
	std::vector<std::vector<std::vector<Vect3d>>> generatedVoxelPoints;
...
public:
	...
	std::vector<std::vector<Vect3d>> TerrainGenerator::points(bool regenerate = false);
	std::vector<std::vector<std::vector<Vect3d>>> TerrainGenerator::voxelPoints(bool regenerate = false);
};